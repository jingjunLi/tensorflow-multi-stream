...
int main(int argc, char* argv[]) {
  ...
  noscope::NoscopeStream stream_test("/home/li/opensource/stanford-futuredata/tensorflow-noscope/tensorflow/noscope/proto/stream.prototxt"); 
  stream_test.SetUp(0, sQueue);
  stream_test.Start();
